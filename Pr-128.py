...
import time
import csv
lin= "https://en.wikipedia.org/wiki/List_of_brown_dwarfs"
    ...
    for i in range(1, 430):
        while True:
            ...
            if current_page_num < i:
                ...
                break
        for ul_tag in soup.find_all("tr", attrs={"class"}):
...
for index, data in enumerate(planet_data):
    ...
    new_planet_data_element = [elem.replace("") for elem in new_planet_data_element]
